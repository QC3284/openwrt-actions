...
| luci-app-online-upgrade | `QC3284/luci-app-online-upgrade` | Online firmware upgrade. Original repo is cloned then overlaid with adapted scripts from `script/online-upgrade/` — replaces fixed tag + x86 matching with dynamic multi-device release list lookup |
